...
const LazyImage: React.FC<React.ImgHTMLAttributes<HTMLImageElement> & {
  fallbackSrc?: string;
}> = ({ src, alt = '', className, fallbackSrc, onLoad, ...props }) => {
...
const Home: React.FC = () => {
  ...
  const minCheckOut = useMemo(() => checkIn || todayISO, [checkIn, todayISO]);
  ...
  const getAmenityIcon = useCallback((amenity: string) => {
    ...
    switch (amenity.toLowerCase()) {
      ...
      case 'restaurant':
      case 'bar': return <Coffee {...iconProps} />;
  ...
  }, [searchQuery, selectedArea, checkIn, checkOut, guests, navigate]);
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              {/* Nagpur Stats */}
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                {Object.entries(nagpurStats).map(([key, value], index) => (
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/hotels"
                  className="group bg-white text-orange-600 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
                ...
                <Link
                  to="/explore"
                  className="group border-2 border-white text-white hover:bg-white hover:text-orange-600 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 flex items-center justify-center space-x-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
            ...
            <form onSubmit={handleSearch} className="space-y-6" aria-label="Hotel search form">
              ...
              <div className="flex justify-center">
                <button
                  type="submit"
                  disabled={loading}
                  className="bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 disabled:opacity-60 disabled:cursor-not-allowed text-white px-12 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105 flex items-center space-x-3 shadow-lg hover:shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500"
                  aria-label="Search hotels in Nagpur"
                >
                  <Search className="h-5 w-5" />
                  <span>{loading ? 'Searching...' : 'Search Nagpur Hotels'}</span>
                </button>
              </div>
            </form>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {POPULAR_HOTEL_AREAS.slice(0, 6).map((area) => (
              <div
                ...
                tabIndex={0}
                onClick={() => handleQuickAreaSearch(area.name)}
                onKeyDown={(e) => handleKeyDown(e, () => handleQuickAreaSearch(area.name))}
                className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {nagpurFeaturedHotels.map((hotel) => (
              <div
                key={hotel.id}
                className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 focus-within:ring-2 focus-within:ring-orange-500"
              >
                <div className="relative">
                  <LazyImage
                    src={hotel.image}
          ...
          <div className="text-center mt-12">
            <Link
              to="/hotels"
              className="bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105 inline-flex items-center space-x-3 shadow-lg hover:shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500"
            >
              <span>View All Nagpur Hotels</span>
              <ArrowRight className="h-5 w-5" />
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className="text-center p-6 rounded-2xl hover:bg-white hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
              >
            ...
            {[
              {
                ...
                title: "18 Areas Covered",
                description: "From Sitabuldi to Seminary Hills, we cover every major area in Nagpur",
                link: "/explore",
                cta: "Explore Areas →"
              },
              {
                ...
                description: "Visit Deekshabhoomi, Ambazari Lake, Sitabuldi Fort and more iconic places",
                link: "/explore",
              ...
              },
              {
                ...
                title: "Local Cuisine",
                description: "Experience authentic Saoji food, Tarri Poha and famous Nagpur oranges",
                link: "/explore",
                cta: "Food Guide →"
              }
            ].map((item, index) => (
              <div
                key={index}
                className="text-center p-6 rounded-2xl border border-gray-100 hover:shadow-lg hover:scale-105 transition-all duration-300"
              >
                <div className="bg-orange-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 hover:rotate-12 transition-transform duration-300">
                  {item.icon}
                </div>
                ...
                <Link
                  to={item.link}
                  className="text-orange-600 hover:text-orange-700 font-medium inline-block focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 rounded"
                >
                  {item.cta}
                </Link>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
              >
      ...
      <section className="py-16 bg-gradient-to-r from-orange-500 to-red-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/hotels"
              className="bg-white text-orange-600 hover:bg-orange-50 hover:scale-105 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 flex items-center justify-center space-x-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
            ...
            <Link
              to="/explore"
              className="border-2 border-white text-white hover:bg-white hover:text-orange-600 hover:scale-105 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 flex items-center justify-center space-x-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
